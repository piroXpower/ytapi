...
app = FastAPI(title="MusicAPI Pro Turbo Engine")
...
def _extract_local(video_id: str, media_type: str, quality: str) -> str:
...
async def get_stream_url_fastest(video_id: str, media_type: str, quality: str) -> str:
...
async def stream(
    ...
    media_url = await get_stream_url_fastest(video_id, media_type, quality)
    if not media_url:
        raise HTTPException(status_code=404, detail="Media stream could not be loaded.")
    ...
    return StreamingResponse(
        ...
        headers={
            ...
            "X-Powered-By": "MusicAPI-Turbo/3.5",
        },
    )
...
<head>
    ...
    <style>
        :root { --bg: #090d16; --surface: #111726; --border: #1f293d; --primary: #38bdf8; --accent: #0ea5e9; --text: #f8fafc; --muted: #94a3b8; }
...
<body>
    ...
    <div class="hero">
        ...
        <p>Ultra-low latency competitive resolver with automatic zero-credential anti-bot fallback.</p>
    </div>
    <div class="container">
