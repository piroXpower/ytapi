...
try:
    ...
    print(f"PostgreSQL connection initialization failed: {e}")
...
def init_db():
    try:
        ...
        print(f"Database init error (non-fatal): {err}")
...
<body>
    ...
    <div class="hero">
        ...
        <p>Low-latency media piping with separate audio and video request telemetry.</p>
    </div>
    <div class="container">
